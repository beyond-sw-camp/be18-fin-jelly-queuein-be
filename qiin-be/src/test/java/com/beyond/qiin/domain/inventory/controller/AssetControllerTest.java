...
class AssetControllerTest {
    ...
    @MockBean private AssetCommandService assetCommandService;
    @MockBean private AssetQueryService assetQueryService;

    @MockBean private JwtTokenProvider jwtTokenProvider;
    @MockBean private RedisTokenRepository redisTokenRepository;
    @MockBean private ArgumentResolver argumentResolver;
    ...
    void deleteAsset_success() throws Exception {
        ...
        mockMvc.perform(delete("/api/v1/assets/5")
    ...
    void moveAsset_success() throws Exception {
        ...
        MoveAssetRequestDto request = MoveAssetRequestDto.builder()
                                                         .parentName("회의실A")
                                                         .build();
    ...
    void getDescendants_success() throws Exception {
        ...
        List<DescendantAssetResponseDto> items = List.of(
                DescendantAssetResponseDto.builder()
                                          .assetId(100L)
                                          .name("노트북1")
                                          .categoryName("전자기기")
                                          .status("사용 가능")
    ...
    void getTree_success() throws Exception {
        ...
        List<TreeAssetResponseDto> tree = List.of(
                TreeAssetResponseDto.builder()
                                    .assetId(1L)
                                    .name("본관")
                                    .children(List.of())
                                    .build()
