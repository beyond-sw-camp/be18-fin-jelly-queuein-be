...
public class ApplyReservationIntegrationTest {
    ...
    void 승인예약_정상_생성() {
        ...
        User applicant = userJpaRepository.save(User.builder()
                ...
                .build());
        User attendant1 = userJpaRepository.save(User.builder()
                .dptId(1L)
                .userNo("A001")
                .userName("참석자1")
                .email("att1@test.com")
                ...
                .hireDate(Instant.now())
                .build());
        User attendant2 = userJpaRepository.save(User.builder()
                .dptId(1L)
                .userNo("A002")
                .userName("참석자2")
                .email("att2@test.com")
        ...
        Category category = categoryJpaRepository.save(
                Category.builder().name("공간").description("공간 카테고리").build());

        Asset asset = assetJpaRepository.save(Asset.builder()
                .category(category)
                .name("회의실 A")
                .description("테스트 회의실")
                .image(null)
        ...
        // then
        Reservation saved =
                reservationJpaRepository.findById(response.getReservationId()).orElseThrow();
