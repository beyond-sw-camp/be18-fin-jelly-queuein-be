...
//            userReservationsQueryAdapter.search(userId, condition, pageable);
//
...
//        userReader.findById(userId);
//
//        Page<ReservableAssetResponseDto> page = reservableAssetsQueryAdapter.search(condition, pageable);
//
//        return PageResponseDto.from(page);
//
//
...
//
//
//        Page<GetAppliedReservationResponseDto> page = appliedReservationsQueryAdapter.search(condition, pageable);
//
//        return PageResponseDto.from(page);
//
//        //
