...
public class ReservationQueryController {
    ...
    @GetMapping("/me")
    public ResponseEntity<GetUserReservationListResponseDto> getUserReservations(
            @PathVariable Long userId, @RequestParam LocalDate date) {
        GetUserReservationListResponseDto getUserReservationListResponseDto =
                reservationQueryService.getReservationsByUserId(userId, date);
    ...
    public ResponseEntity<ReservableAssetListResponseDto> getReservableAssets(@RequestParam LocalDate date) {
        ReservableAssetListResponseDto reservableAssetListResponseDto =
                reservationQueryService.getReservableAssets(date);
        return ResponseEntity.ok(reservableAssetListResponseDto);
    }

    // 예약 가능 시간대 조회
    @GetMapping("/{assetId}/times")
    public ResponseEntity<ReservableAssetTimeResponseDto> getReservableAssetTimes(
            @RequestParam Long assetId, @RequestParam LocalDate date) {
        ReservableAssetTimeResponseDto reservableAssetTimeResponseDto =
                reservationQueryService.getReservableAssetTimes(assetId, date);
    ...
    public ResponseEntity<GetAppliedReservationListResponseDto> getAppliedReservations(@RequestParam LocalDate date) {
        GetAppliedReservationListResponseDto getAppliedReservationListResponseDto =
                reservationQueryService.getReservationApplies(date);
